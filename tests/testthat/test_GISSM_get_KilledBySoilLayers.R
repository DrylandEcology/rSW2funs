...
test_that("GISSM_get_KilledBySoilLayers", {
  ...
  expect_equal(GISSM_get_KilledBySoilLayers(NA, cond1), NA)
  expect_equal(GISSM_get_KilledBySoilLayers(Nl, cond1), FALSE)
  expect_equal(GISSM_get_KilledBySoilLayers(Nl, cond2), TRUE)
  expect_equal(GISSM_get_KilledBySoilLayers(Nl2, cond3), TRUE)
  expect_equal(GISSM_get_KilledBySoilLayers(2 * Nl2, cond3), FALSE)
  expect_equal(GISSM_get_KilledBySoilLayers(Nl3, cond4), TRUE)
  expect_equal(GISSM_get_KilledBySoilLayers(2 * Nl3, cond4), FALSE)
  expect_equal(GISSM_get_KilledBySoilLayers(3 * Nl3, cond4), FALSE)
