...
tmp <- c("regimes_done", "has_simulated_SoilTemp", "has_realistic_SoilTemp")
stopifnot(
  as.logical(SMTR[tmp]),
...
cat(names(Tregime)[Tregime])

# --> Soil moisture regime is "Xeric" / "Typic-Xeric"
Sregime <- colMeans(SMTR[["SMR"]]) >= crit_agree_frac
cat(names(Sregime)[Sregime])
```
